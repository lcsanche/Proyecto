 ...
 * @author PC-4
 */
public class vista_casa_oasis extends javax.swing.JFrame {

    /**
     * Creates new form Diseño_casa_oasis
     */
    public vista_casa_oasis() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vista_casa_oasis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vista_casa_oasis().setVisible(true);
            }
        });
    }
